...
class CaravanPlayerAction implements PlayerActionInterface {
    gameplayAction = GameplayActionRepository.createFromName(ActionName.Caravan)
...
export default CaravanPlayerAction

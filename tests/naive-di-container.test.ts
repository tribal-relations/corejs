...
import Arm from '../src/domain/action-performer/Arm.ts'
import Conquer from '../src/domain/action-performer/Conquer.ts'
import Cult from '../src/domain/action-performer/Cult.ts'
import Expedition from '../src/domain/action-performer/Expedition.ts'
import GoTo1stRadius from '../src/domain/action-performer/GoTo1stRadius.ts'
import GoTo2ndRadius from '../src/domain/action-performer/GoTo2ndRadius.ts'
import GoTo3rdRadius from '../src/domain/action-performer/GoTo3rdRadius.ts'
import Research from '../src/domain/action-performer/Research.ts'
